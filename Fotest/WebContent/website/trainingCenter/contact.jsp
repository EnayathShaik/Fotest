...
<cf:form action="contactTCSave.fssai" name="myForm" method="POST" commandName="contactTrainee" onsubmit="return validateFields();"> 
section>
      ...
      <div class="container-fluid">
        ...
        <ul class="sidebar-nav">
          ...
          <div id="page-content-wrapper">
            ...
            <span class="orange-font">Welcome  ${loginUser.loginDetails.loginId}</span> </a> </div>
          </div>
