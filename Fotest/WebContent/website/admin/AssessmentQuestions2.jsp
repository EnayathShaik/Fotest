...
<cf:form action="assessmentquestions2.fssai" name="tiForm" method="POST" commandName="AssessmentQuestionForm" onsubmit="return validateFields();"> 
...
function editassessmentquestion(id){
    ...
    alert("2");
 	$.ajax({
 	      type: 'post',
 	      url: 'Asssessmentquestion/edit/'+id+'.fssai',
									...
									<cf:options items="${listUnitMaster}" itemLabel="unitCode" itemValue="unitId" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    ...
                                                    <input type="submit"  class="btn login-btn show-details-vacancy collapsed" data-toggle="collapse" data-target="#show-result" aria-expanded="false" value="Get Contents"/> 
