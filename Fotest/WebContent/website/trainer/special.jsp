...
function getCourseDetails(){
    ...
    <cf:form action="specialTrainerSave.fssai" name="myForm" method="POST" commandName="courseEnrolledUserForm" >  
    <!-- horizontal navigation -->
    <section>
        ...
        <div class="container-fluid"> 
          ...
          <div class="row">
            <div class="col-xs-12">
              <fieldset >
                <legend>
                <h3>TOT Enrollment: Special Course</h3>
                </legend>
                <div class="row"></div>
                <form>
                  <!-- left side -->
...
<cf:option value="Classroom" label="Classroom" />
                    ...
                    <div class="form-group">
                      <label>Training Centre: City</label>
