    ...
    <%@include file="leftMenuTrainer.jspf" %>
              ...
              <div id="page-content-wrapper">
                <div class="container-fluid"> 
                  <!-- vertical button -->
                  <div class="row">
                <div class="col-lg-12"> <a href="#menu-toggle" class="vertical-menu-position-btn" id="menu-toggle"> <i class="fa fa-bars"></i> <span class="orange-font">Welcome Mr. ${loginUr.firstName}</span> </a> </div>
              </div>
                      ...
                      <div class="table-responsive">
                        <div class="col-xs-12">
                          <fieldset>
                            ...
                            <h4><a class="link-bg text-center" href="certificatetrainer.fssai">Generate Certificate</a></h4>
                          </fieldset>
                          <br>
