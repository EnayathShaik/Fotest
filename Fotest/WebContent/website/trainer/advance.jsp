...
function getCourseDetails(){
	...
	$.ajax({
	      ...
	      var j=1;
			...
			$.each(mainData1 , function(i , obj)
			{
			$('#newTable').append('<tr id="tableRow"><td><input type="hidden" name="getCalander" id="h" value="'+obj[0]+'" /><input type="radio" name="getCalander" onclick="gettid();" id="trainingCalendarIdd"  value="'+obj[0]+'"/></td><td>'+obj[1]+'</td><td>'+obj[2]+'</td><td>'+obj[3]+'</td><td>'+obj[5]+'</td><td>'+obj[6]+'</td></tr>');	
    ...
    <cf:form action="advanceTrainerSave.fssai" name="myForm" method="POST" commandName="courseEnrolledUser" >
    <section>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <span class="orange-font">Welcome Trainer</span> </a>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <fieldset>
                                                <legend>
                                                    <h3>TOT Enrollment: Advance Course</h3> </legend>
                                                <div class="row"></div>
                                                <form>
                                                    <!-- left side -->
...
<cf:option value="Classroom" label="Classroom" />
                                                        ...
                                                        <div class="form-group">
                                                            <label>Training Date</label>
                                                              <input type="date" id="trainingDate" class="form-control" placeholder="Training Date"/> </div>
                                                        <div class="form-group">
...
<cf:option value="0" label="Select District" />
                                                    ...
                                                    <div class="col-md-6 col-xs-12">
                                                        <div class="form-group">
                                                            <a href="#" onclick="getCourseDetails();" class="form-control login-btn btn pull-right" style="width: 50%;">Show Details</a> </div>
                                                        <!-- residential address -->
                                                    </div>
                                                </form>
