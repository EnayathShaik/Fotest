...
<cf:form action="contactAssessorSave.fssai" name="myForm" method="POST" commandName="contactTrainee" onsubmit="return validateFields();"> 
...
<cf:input path="messageDetails" maxlength="250"  placeholder="Enter Your Message (250 Words)" class="form-control"   />
                                      </div>
