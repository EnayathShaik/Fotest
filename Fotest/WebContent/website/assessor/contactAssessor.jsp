...
function validateFields() {
   ...
   <cf:form action="contactAssessor.fssai" name="myForm" method="POST" commandName="contactTraineee" onsubmit="return validateFields();"> 
        ...
        <div id="wrapper"> 
          ...
          <div id="page-content-wrapper">
            <div class="container-fluid"> 
              ...
              <!-- vertical button -->
              <div class="row">
                <div class="col-lg-12"> <a href="#menu-toggle" class="vertical-menu-position-btn" id="menu-toggle"> <i class="fa fa-bars"></i> <span class="orange-font">Welcome Mr. Lorem </span> </a> </div>
              </div>
