...
<%@ taglib prefix="ct" uri="http://java.sun.com/jsp/jstl/core" %>
 ...
 <cf:form action="printAdmitCard.fssai" name="myForm" method="POST"
	commandName="PrintAdmitCard" onsubmit="return validateFields();">
    <section>
                                    ...
                                    <h1></h1>
                                            ...
                                            <div class="col-xs-12 " id="testt">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                            <fieldset>
                                           <legend>PrintAdmitCard</legend>
                                         <ct:if test="${!empty listPrintAdmitCard}">
                                            <table id="datatablesfosrest" class="table table-bordered table-responsive">
                                               <thead>
                                                ...
                                                <ct:forEach items="${listPrintAdmitCard}" var="listPrintAdmitCard" varStatus="loop">
                                                <tr>
												<td>1</td>
