                ...
                <div class="form-group">
                  <div>
                    <ul class="lab-no">
                      ...
                      <label id="TrainingCentreNameError" class="error visibility">Enter Training Centre Name</label>
                      <cf:errors path="TrainingCentreName" cssClass="error" /></li>
                    </ul>
                  </div>
                   <cf:input path="TrainingCentreName" maxlength="50" class="form-control"  placeholder="Training Centre Name"/>
                </div>
                ...
                <div class="form-group">
                  <div>
                    <ul class="lab-no">
                      ...
                      <li class="style-li error-red">
                      <label id="PANError" class="error visibility">Enter Valid PAN Number</label>
                ...
                <div class="form-group">
                  <div>
                    <ul class="lab-no">
                      ...
                      <li class="style-li error-red">
                      <label id="TitleError" class="error visibility">Select Titles</label>
                ...
                <div class="form-group">
                  <div>
                    <ul class="lab-no">
                      ...
                      <li class="style-li error-red">
                      <label id="FirstNameError" class="error visibility">Enter First Name</label>
                ...
                <div class="form-group">
                  <div>
                    <ul class="lab-no">
                      ...
                      <li class="style-li error-red">
                      <label id="LastNameError" class="error visibility">Enter Last Name</label>
                ...
                <div class="form-group">
                  <div>
                    <ul class="lab-no">
                      ...
                      <li class="style-li error-red">
                      <label id="TrainingPartnerPermanentLine1Error" class="error visibility">Enter Training Center Address Line 1</label>
                      <cf:errors path="TrainingPartnerPermanentLine1" cssClass="error" /></li>
                    </ul>
                  </div>
                  <cf:input path="TrainingPartnerPermanentLine1" maxlength="100" class="form-control"  placeholder="Training Partner Address 1"/>
                </div>
                <div class="form-group">
                  <div>
                    <ul class="lab-no">
                      ...
                      <li class="style-li error-red">
                      <label id="TrainingPartnerPermanentLine2Error" class="error visibility">Enter Training Center Address Line 2</label>
                      <cf:errors path="TrainingPartnerPermanentLine2" cssClass="error" /></li>
                    </ul>
                  </div>
                  <cf:input path="TrainingPartnerPermanentLine2" maxlength="100" class="form-control"  placeholder="Training Partner Address 2"/>
                </div>
                <div class="form-group">
                  <div>
                    <ul class="lab-no">
                      ...
                      <li class="style-li error-red">
                      <label class="error visibility" id="TrainingPartnerPermanentStateError">Select State</label>
                      <cf:errors path="TrainingPartnerPermanentState" cssClass="error" />
                      </li>
                    </ul>
                  </div>
                 ...
                 <div class="form-group">
                  <div>
                    <ul class="lab-no">
                      ...
                      <li class="style-li error-red"><label class="error visibility" id="TrainingPartnerPermanentDistrictError">Select District</label>
                      <cf:errors path="TrainingPartnerPermanentDistrict" cssClass="error" />
                      </li>
                    </ul>
                  </div>
                ...
                <div class="form-group">
                  <div>
                    <ul class="lab-no">
                      ...
                      <li class="style-li error-red"><label class="error visibility" id="TrainingPartnerPermanentCityError">Select City</label>
                      <cf:errors path="TrainingPartnerPermanentCity" cssClass="error" />
                      </li>
                    </ul>
                  </div>
                ...
                <div class="form-group">
                  <div>
                    <ul class="lab-no">
                      ...
                      <li class="style-li error-red">
                      <label class="error visibility" id="TrainingPartnerPermanentPincodeError">Insert Valid PIN Code</label>
                      <cf:errors path="TrainingPartnerPermanentPincode" cssClass="error" />
                      </li>
                    </ul>
                  </div>
                   <cf:input path="TrainingPartnerPermanentPincode" onkeypress="return AvoidSpace(event)" class="form-control"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" maxlength="6" placeholder="Pincode"/>
                </div>
                 ...
                 <div class="form-group">
                  <div>
                    <ul class="lab-no">
                      ...
                      <li class="style-li error-red">
                      <label class="error visibility" id="TrainingPartnerPermanentEmailError">Enter Valid Email Id</label>
                      <cf:errors path="TrainingPartnerPermanentEmail" cssClass="error" /></li>
                    </ul>
                  </div>
                  <cf:input path="TrainingPartnerPermanentEmail" onkeypress="return AvoidSpace(event)" maxlength="50" class="form-control"  placeholder="Email"/>
                </div>
                 <div class="form-group">
                  <div>
                    <ul class="lab-no">
                      ...
                      <li class="style-li error-red">
                      <label class="error visibility" id="TrainingPartnerPermanentMobileError">Enter Valid Mobile Number</label>
                      <cf:errors path="TrainingPartnerPermanentMobile" cssClass="error" /></li>
                    </ul>
                  </div>
                  <cf:input path="TrainingPartnerPermanentMobile" onkeypress="return AvoidSpace(event)" class="form-control"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" maxlength="10"  placeholder="Mobile"/>
                </div>
              <!-- right side ends -->
            </fieldset>
          </div>
                ...
                <div class="form-group">
                  <div>
                    <ul class="lab-no">
                      ...
                      <li class="style-li error-red"> 
                      <label class="error visibility" id="SeatCapacityPerSessionError">Enter Seating capacity Per session</label>
                      <cf:errors path="SeatCapacityPerSession" cssClass="error" /></li>
                    </ul>
                  </div>
                 <cf:input path="SeatCapacityPerSession"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" maxlength="4" class="form-control"  placeholder="No of seats"/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <div>
                    <ul class="lab-no">
                      ...
                      <li class="style-li error-red">
                      <label class="error visibility" id="NoOfInHouseTrainersError">Enter Number of in-house trainers</label>
                       <cf:errors path="NoOfInHouseTrainers" cssClass="error" /></li>
                    </ul>
                  </div>
                   <cf:input path="NoOfInHouseTrainers"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" maxlength="4" class="form-control"  placeholder="No Of In House Trainers" />
                </div>
                <div class="form-group">
                  <div>
                    <ul class="lab-no">
                      ...
                      <li class="style-li error-red">
                       <label class="error visibility" id="NoOfYearsInBusinessOfTrainingError">Enter Number of years in Business of training </label>
                      <cf:errors path="NoOfYearsInBusinessOfTraining" cssClass="error" /></li>
                    </ul>
                  </div>
                ...
                <div class="form-group">
                  <div>
                    <ul class="lab-no">
                      ...
                      <li class="style-li error-red">
                      <label class="error visibility" id="NoOfTrainingSessionWishToConductInAMonthError">Enter Number Sessions Conduct In A Month </label>
                      <cf:errors path="NoOfTrainingSessionWishToConductInAMonth" cssClass="error" /></li>
                    </ul>
                  </div>
...
I have read and understood the Terms & Conditions and the Privacy Policy of FSSAI.<!--  </a> -->
</div>
</div>
