...
<cf:form action="updateTrainer.fssai" name="myForm" method="GET" commandName="updateInformation" onsubmit="return validateFields();"> 
              ...
              <div class="col-xs-12">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                  <ul class="nav navbar-nav">
                    ...
                    <li class="hori active"><a href="update-profile.html">Update Profile</a></li>
                      ...
                      <fieldset>
                        ...
                        <div class="col-md-6 col-xs-12">
                          <div class="form-group">
                            ...
                            <input type="text"  class="form-control" placeholder="User ID"  disabled="disabled" id="UserId" required  value=" ${loginUser.loginDetails.loginId}">
                          </div>
                          <div class="form-group">
                            <div>
                              <ul class="lab-no">
                            ...
                            <input type="text" class="form-control"  disabled="disabled" placeholder="Aadhar Number" required value=" ${loginUser.aadharNumber}">
                          </div>
                          <div class="form-group">
                            <div>
                              <ul class="lab-no">
                            ...
                            <input type="date"   class="form-control"  id="DOB" placeholder="Date" required      value="${loginUser.DOB }">
                          </div>
                          <hr>
                          <div class="form-group">
                            <div>
                          ...
                          <div class="form-group">
                            ...
                            <label class="radio-inline">
                              <input type="radio" id="gender" name="optradio" >
                              Yes </label>
                            <label class="radio-inline">
                        ...
                        <div class="col-md-6 col-xs-12">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="First Name" disabled="disabled" required value="${loginUser.firstName }">
                          </div>
                          <div class="form-group">
                            <div>
                              <ul class="lab-no">
                            ...
                            <input type="text" class="form-control" placeholder="Middle Name" disabled="disabled" required value="${loginUser.middleName }">
                          </div>
                          <div class="form-group">
                            <div>
                              <ul class="lab-no">
                            ...
                            <input type="text"  class="form-control" placeholder="Last Name" disabled="disabled" required value="${loginUser.lastName}">
                          </div>
                        </div>
                      </fieldset>
                    </div>
      ...
      <div class="col-md-2 hidden-xs"></div>
                   ...
                   <div class="col-md-4 hidden-xs"></div>
                    <div class="col-md-4 col-xs-12">
                      <div class="pull-right">
                        <div class="form-group"> <a href="login.html">
